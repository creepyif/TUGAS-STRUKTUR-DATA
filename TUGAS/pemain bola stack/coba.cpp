...
{	int pilih=0;
	...
	switch(pilih){
case 1:{if(fullStack(player)){cout<<"tumpukkan penuh penuh"<<endl;}
	   	    else {Push_Stack(player);}break;}
case 2:{if(emptyStack(player)){cout<<"tumpukkan kosong"<<endl;}
		 	  else {Pop_Stack(player);}break;}

case 3:{if(emptyStack(player)){cout<<"tumpukkan kosong"<<endl;}
